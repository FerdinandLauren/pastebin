    ...
    <footer id="contact" class="bg-bookmark-white pt-16 pb-12">
        <div class="container">
            ...
            <div class="w-full pt-10 border-t border-slate-700">
                ...
                <!-- Youtube -->
                <a href="#" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-secondary hover:border-gray-500 hover:bg-gray-500 hover:text-white">
